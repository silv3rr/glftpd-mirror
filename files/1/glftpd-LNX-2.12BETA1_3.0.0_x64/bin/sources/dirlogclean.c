...
int main ( int argc, char *argv[]) {
   ...
   char datapath[255], dirlogfile[255], dirlogtemp[255];
   char cleanname[1024];
   struct dirlog buffer;
   int x = 1;
  
   if (argc < 2) {
     printf("USAGE: %s [OPTIONS] [DIRMASK]\n", argv[0]);
     printf("\t-r [alt-config]\n");
     return 1;
   }
